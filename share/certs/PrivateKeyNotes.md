...
unlocked to sign the Fokawa-Qt.app bundle.
...
allowing somebody to distribute a Fokawa-Qt.app or fokawa-qt-setup.exe with a valid
...
that the fokawa-qt.exe file inside the installer had not been tampered with.
