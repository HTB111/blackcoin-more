...
const string strMessageMagic = "Fokawa Signed Message:\n";
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck)
{
    ...
    // Fokawa also requires DER encoding of pubkeys
    flags |= SCRIPT_VERIFY_DERKEY;
    // Fokawa also requires low S in sigs
