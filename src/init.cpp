 ...
 * between fokawad, and fokawa-qt and non-server tools.
*/
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/fokawablockchain/core>";
    const std::string URL_WEBSITE = "<https://fokawa.io/>";
    ...
    return FormatParagraph(strprintf("Copyright (C) %i-%i The Bitcoin Core Developers", 2009, COPYRIGHT_YEAR)) + "\n" +
           ...
           "\n" +
           FormatParagraph(strprintf("Copyright (C) %i The Fokawa Developers", 2025)) + "\n" +
           "\n" +
           FormatParagraph(strprintf(_("Please contribute if you find Fokawa useful. "
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Fokawa More version %s\n", FormatFullVersion());
}
