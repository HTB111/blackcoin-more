    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click fokawa: links
...
//
// OSX-specific way of handling fokawa: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in fokawa: URIs
...
bool PaymentServer::handleURI(const QString &scheme, const QString &s)
{
    ...
    else
    {
        Q_EMIT message(tr("URI handling"), tr("URI cannot be parsed! This can be caused by an invalid "
                                              "Fokawa address or malformed URI parameters."),
            CClientUIInterface::ICON_WARNING);
    }
