...
These are the dependencies currently used by Fokawa. You can find instructions for installing them in the `build-*.md` file for your platform.
...
Telegram - https://t.me/fokawanl
Keybase  - https://keybase.io/team/fokawa/
