...
- [Development guidelines](#development-guidelines)
    - [General Fokawa](#general-bitcoin-core)
    - [Wallet](#wallet)
    - [General C++](#general-c)
...
Fokawa uses [Doxygen](https://www.doxygen.nl/) to generate its official documentation.
...
Fokawa is a multi-threaded application, and deadlocks or other
...
Fokawa can be compiled with various "sanitizers" enabled, which add
...
However, in open source software such as Fokawa, where everyone uses
...
pay attention to for reviewers of Fokawa code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers.
  ...
  - *Rationale*: Fokawa uses tinyformat, which is type safe. Leave them out to avoid confusion.
...
Some of these are maintained by active developers of Fokawa, in which case changes should probably go
directly upstream without being PRed directly against the project. They will be merged back in the next
subtree merge.

Others are external projects without a tight relationship with our project. Changes to these should also
be sent upstream, but bugfixes may also be prudent to PR against Fokawa so that they can be integrated
...
compatibility between nodes. This happened in Fokawa 0.8 (when LevelDB was
...
- Wallet RPCs call BlockUntilSyncedToCurrentChain to maintain consistency with
  ...
  - *Rationale*: In previous versions of Fokawa, the wallet was always
